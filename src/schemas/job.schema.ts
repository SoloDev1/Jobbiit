...
const jobFields = z.object({
  ...
  requirements: z.string().trim().min(1).max(5_000).optional(),
  type:         jobTypeEnum,
...
export const addJobCommentSchema = z
  .object({
...
export type AddJobCommentInput = z.infer<typeof addJobCommentSchema>
